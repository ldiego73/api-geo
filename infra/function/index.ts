...
const geoFunctionRole = new aws.iam.Role("geoFunctionRole", {
  ...
  name: "geoFunctionRole",
});

new aws.iam.RolePolicyAttachment("geoFunctionRoleAttachment", {
  role: geoFunctionRole,
  policyArn: aws.iam.ManagedPolicy.AWSLambdaBasicExecutionRole,
});

const geoRepo = new aws.ecr.Repository("geoFunctionRepo", {
  name: "geo-function-repo",
});
const geImage = awsx.ecr.buildAndPushImage(
  "geoFunctionImage",
  {
    context: "../../",
...
new aws.lambda.Permission(
  "geoFunctionPermission",
  {
    ...
    statementId: "geoFunctionPermission",
...
const geoFunctionApiIntegration = new aws.apigatewayv2.Integration(
  "geoFunctionApiIntegration",
  {
...
const geoFunctionApiStage = new aws.apigatewayv2.Stage(
  "geoFunctionApiStage",
  {
    apiId: geoFunctionApi.id,
    name: stack,
